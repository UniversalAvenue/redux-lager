...
exports.selectPageStats = exports.selectPagedRow = exports.selectIsPageLoading = exports.selectFetchState = exports.selectResult = exports.selectFullEntity = exports.selectEntity = exports.selectEntities = undefined;
...
var selectFetchState = exports.selectFetchState = function selectFetchState(identifier) {
  return function (state) {
    ...
    return _lodash2.default.pick(store, 'loading', 'error');
  };
};
    ...
    return function (fetchPage) {
      ...
      return function (pos) {
        ...
        return _lodash2.default.reduce(schemaKeys, function (sum, key) {
          ...
          return Object.assign(sum, _defineProperty({}, key, selectEntity('orders')(id)(state)));
        }, {});
      };
    };
  };
