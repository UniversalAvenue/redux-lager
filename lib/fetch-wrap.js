...
function requestHelper(map) {
  ...
  return _lodash2.default.reduce(helpers, function (sum, helper, key) {
    return _extends({}, sum, _defineProperty({}, key, function () {
      ...
      return requestHelper.apply(null, [map].concat(middlewares, [helper.apply(null, args)]));
    }));
  }, {
...
function fetchWrap(options) {
  ...
  var prep = prepareRequest ? prepareRequest.apply(null, [requestHelper(function (id) {
    return id;
  })].concat(prepareArgs)) : prepareNothing;
