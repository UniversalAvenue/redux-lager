...
exports.LAGER_FAILURE = exports.LAGER_SUCCESS = exports.LAGER_REQUEST = exports.LAGER_RESET = exports.LAGER_ACTION = exports.LAGER_FETCH = undefined;
...
var LAGER_FETCH = exports.LAGER_FETCH = '__lager_fetch';
var LAGER_ACTION = exports.LAGER_ACTION = '__lager_action';

var LAGER_RESET = exports.LAGER_RESET = 'LAGER RESET';
  ...
  return function (getState) {
    return function (input, schema, init) {
      return (0, _fetchWrap2.default)(options, getState())(input, init).then(function (response) {
        return !_lodash2.default.isFunction(response.json) ? Promise.resolve({ json: {}, response: response }) : response.json().then(function (json) {
        ...
        var camelCase = (0, _humps.camelizeKeys)(json);
        return (0, _normalizr.normalize)(camelCase, schema);
      }, function (error) {
