  ...
  return function (getState) {
    return function (input, schema, init) {
      return (0, _fetchWrap2.default)(options, getState())(input, init).then(function (response) {
        ...
        console.log('response', (0, _normalizr.normalize)(json, schema));
  ...
  return function (store) {
    ...
    return function (next) {
      return function (action) {
        ...
        return callApi(input, schema, fetchOptions, query, data).then(function (response) {
